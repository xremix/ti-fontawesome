...
module.exports = function(){
	...
	function createLabel(params){
		params = params || {};
		params.text = getIcon(params.icon) ||  getIcon('fa-warning');
		if(params.font){
			if(!params.font.fontFamily){
				params.font.fontFamily = 'FontAwesome';
			}
		}else{
			params.font = {
		...
		label.setIcon = function(iconStr){
			label.text = getIcon(iconStr);
		};
		return label;
	}

	function getIcon(iconString){
		iconString = iconString ? iconString.toLowerCase() : "fa-bug";
		switch (iconString){
		  case 'fa-glass':
		    return "\uf000";
		  case 'fa-music':
